                    ...
                    <div id="cliente" class="collapse show" role="tabpanel" aria-labelledby="hcliente">
                        <div class="card-block">
                            <div class="list-group">
                                ...
                                <a class="list-group-item list-group-item-action active" href="#informacion">Informacion de contacto</a>
                                <a class="list-group-item list-group-item-action" href="{{route('adm.cli.per.ban',$ruc_cl)}}">Cta Bancarias</a>
                            </div>
                        </div>
                    </div>
                </div>
